...
Feature: Licenses management
    ...
    Scenario: Listing licenses
        ...
        And There is a license "key6" for vessel "00000000-0000-0000-0000-00000000000a" of customer "00000000-0000-0000-0000-00000000000b" with count 1 and expiration date "2015-07-02T03:20:00+02:00"
    ...
    Scenario: Listing licenses next page
        ...
        And There is a license "key8" for vessel "00000000-0000-0000-0000-00000000000c" of customer "00000000-0000-0000-0000-00000000000d" with count 3 and expiration date "2009-03-23T10:00:00+02:00"
